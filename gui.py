...
def on_acquire_image():
    ...
    if ret:
        ...
        acquired_image_path = f"sources/webcam_{timestamp}.jpg"
...
image_path = "sources/noimage.jpg"  # <-- Cambia con il percorso della tua immagine
load_image(image_path)
