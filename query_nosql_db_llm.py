...
# work (172.16.61.73):
# llama3.3:70b-instruct-fp16, qwen2.5:14b-instruct-q8_0, qwen2.5:72b-instruct-fp16, mistral:7b-instruct-fp16

OLLAMA_API_URL = "http://172.16.61.73:11434/api/generate"
# OLLAMA_API_URL = "http://localhost:11434/api/generate"

text_model = "mistral:7b-instruct-fp16"
temp = 0.8
...
if __name__ == "__main__":
    ...
    if "matched_file_image_name" not in df.columns or "input_description" not in df.columns:
        ...
        output_path = "meta_zeroshot_mistral_7b-instruct-fp16.xlsx"
